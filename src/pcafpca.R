...
# Take a look to see how we can fit a time-series model.
...
# fPCA
library(fdapace)
tmplist = MakeFPCAInputs(ID = rep(1:dim(data2)[1], each = 1140),
                         tVec = rep(1:1140, by = dim(data)[1]),
